        ...
        <ul className="header__menu">
          <li className="header__menu-item">
            <a className="header__menu-link" href="#">
              <svg className="header__basket" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="header__menu-item">
            <a className="header__menu-link" href="#">
              <svg className="header__likes" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="header__menu-item">
            <a className="header__menu-link" href="#">
              <svg className="header__profile" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <ul className="sneakers__cards">
            <li className="card">
              ...
              <div className="card__price-and-add">
                ...
                <p className="card__price-number">12 999 руб.</p>
